 ...
 * =====================================================
 * PublicComingSoon
 * صفحة احترافية للمحتوى غير المتوفر حاليًا
 * تستخدم بدل رسائل "لا توجد بيانات" الإدارية
 * =====================================================
 */
...
export function PublicComingSoon({
  ...
  homeLabel,
  quoteLabel
}: PublicComingSoonProps) {
  return (
    <section className="app-container app-section">
      <AppCard className="relative overflow-hidden p-8 md:p-12">
        <div className="absolute end-[-6rem] top-[-6rem] h-64 w-64 rounded-full bg-[hsl(var(--color-primary)/0.18)] blur-3xl" />
        <div className="absolute bottom-[-6rem] start-[-6rem] h-64 w-64 rounded-full bg-[hsl(var(--color-accent)/0.14)] blur-3xl" />
